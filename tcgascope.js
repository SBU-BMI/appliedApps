...
// LGG
            ...
            var listDxSlides = function(pp) {
                ...
                if (!openHealth.tcga.dt.lggDx) {
                    ...
                    var pp0 = pp.filter(function(pi) {
                        return openHealth.tcga.dt.lggDx[pi]
                    })
                    pp = []
                    pp0.map(function(pi) {
    ...
    // tumor/lgg/bcr/biotab/clin/nationwidechildrens.org_clinical_patient_lgg.txt
    ...
    doLGG = function() {
        ...
        localforage.getItem('clinical_patient_lgg', function(x) {
            //localforage.removeItem('clinical_patient_lgg')
